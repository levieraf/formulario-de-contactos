...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/formulario/log/solicitud_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/formulario/cache/solicitud/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/formulario/apps/solicitud/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/formulario/cache/solicitud/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/formulario/apps/solicitud/template',
)));
